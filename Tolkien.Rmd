...
newtheme <- theme_minimal(base_family = "Candara")+
  theme(plot.title = element_markdown(size = 11, color = "grey30", margin = margin(b = -8)),
        ...
        strip.text = element_text(size = 7.5, margin = margin(t = 2), 
                                  color = "grey60", 
...
* ___Hobbit/Halfling___

```{r hobbit, fig.width= 11, fig.height = 5}
Legendarium_lex_dispersion(
...
```{r elf, fig.width= 11, fig.height = 5}
Legendarium_lex_dispersion(
  keyword = "elf",
...
```{r dwarf, fig.width= 11, fig.height = 5}
Legendarium_lex_dispersion(
  keyword = "dwarf",
...
```{r orc, fig.width= 11, fig.height = 5}
Legendarium_lex_dispersion(
...
```{r eagle, fig.width= 11, fig.height = 5}
Legendarium_lex_dispersion(
  keyword = "eagle",
  keyword_regex = "eagle")
```
